...
const storeIds=JSON.parse(localStorage.getItem("selectPlace"))||[]
const sortedPlace=storeIds.map(id=>
  AVAILABLE_PLACES.find(
    (place)=>place.id==id
  ))
...
function App() {
  ...
  const [pickedPlaces, setPickedPlaces] = useState(sortedPlace);
  ...
  function handleSelectPlace(id) {
    ...
    if(storeIds.indexOf(id)==-1){
      localStorage.setItem("selectPlace",
